...
class SampleDB(object):
    ...
    def add_matrix_plate_with_specimens(
        ...
        # type: (str, int, list(dict), bool, bool) -> tuple(MatrixPlate, list[StudySubject], list[Specimen], list[MatrixTube])
        """
    ...
    def update_matrix_tube_locations(self, matrix_tube_entries):
        # type: (list(dict)) -> tuple(list(MatrixPlate), list(StudySubject), list(Specimen), list(MatrixTubes))
        """
